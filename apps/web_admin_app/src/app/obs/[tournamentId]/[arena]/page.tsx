...
export default function OBSPage() {
  ...
  return (
    ...
    >
      {/* Outer padding keeps the bar off the screen edges */}
      <div style={{
        position: "fixed",
        bottom: "0.8%",
        left: "1.2%",
        ...
        {/* ── LEFT: score (padded, no round label) ── */}
        <div style={{
          position: "absolute",
          left: "33%", right: "59.5%",
          top: "8%", bottom: "14%",
          ...
          <div style={{
            ...
            fontWeight: 900, fontSize: "3.4vw", lineHeight: 1, letterSpacing: "-0.02em",
          }}>
            {totalRed}
          </div>
        </div>
        ...
        <div style={{
          ...
          {tournamentName && (
            <div style={{
              color: "rgba(255,255,255,0.5)", fontWeight: 700, fontSize: "0.58vw",
          ...
          <div style={{
            color: "rgba(255,255,255,0.6)", fontWeight: 700, fontSize: "0.65vw",
            letterSpacing: "0.18em", textTransform: "uppercase", lineHeight: 1,
          }}>
            Round {currentRound}
          </div>
          <div style={{
            color: timerColor, fontWeight: 900, fontSize: "2.9vw",
        ...
        {/* ── RIGHT: score (padded, no round label) ── */}
        <div style={{
          position: "absolute",
          left: "59.5%", right: "32%",
          top: "8%", bottom: "14%",
